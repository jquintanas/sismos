...
$ar = fopen("../dataAccess/datosEcuador.txt","r");
$arr = explode(",",fgets($ar));
	$usar = array();
for($j=0;$j < count($arr);$j++){
	array_push($usar,(double) $arr[$j]);
}
$datay1 = $usar;//array(5,17,32,24,4,2,36,2,9,24,21,24); 
...
$graph->title->Set('Magnitud de sismos reportados en el pais.');
$graph->SetBox(false);
...
$graph->Add($p1);
$p1->SetColor("#6495ED");
$p1->SetLegend('Sismos de Ecuador');
