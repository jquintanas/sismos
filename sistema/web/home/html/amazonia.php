...
<center><h1 id="tagEstadisticas"> Sismos Reportados en la amazonia Ecuatoriana. </h1></center>
	<?php  include("../../mapa/mapsAmazonia.php");
...
<div id="estadisticasImg" >
	...
	<center><img src="../../esta/indexAmazonia.php" alt="" border="0" id="grafica"></center>
