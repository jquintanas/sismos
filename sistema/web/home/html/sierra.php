...
<center><h1 id="tagEstadisticas"> Sismos Reportados en la sierra Ecuatoriana. </h1></center>
	<?php  include("../../mapa/mapsSierra.php");
...
<div id="estadisticasImg" >
	...
	<center><img src="../../esta/indexSierra.php" alt="" border="0" id="grafica"></center>
